...
import { getInterestBreakdown } from "src/utils/compoundApyHelpers";
import { formatNumber, getFullDisplayBalance } from "src/utils/formatBalance";
...
const DepositModal: React.FC<DepositModalProps> = ({
  ...
  const annualRoiAsNumber = annualRoi?.toNumber() as number;
