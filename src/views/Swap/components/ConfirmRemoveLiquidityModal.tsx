    ...
    return (
      <AutoColumn gap="md">
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyA as Currency} size="24px" />
        ...
        <RowBetween align="flex-end">
          ...
          <RowFixed gap="4px">
            <CurrencyLogo currency={currencyB as Currency} size="24px" />
            <Text fontSize="24px" ml="10px">
              {currencyB?.symbol}
            </Text>
          </RowFixed>
    ...
    return (
      <>
        <RowBetween>
          ...
          <RowFixed>
            <DoubleCurrencyLogo currency0={currencyA as Currency} currency1={currencyB as Currency} margin />
