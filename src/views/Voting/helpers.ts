import { SNAPSHOT_HUB_API } from "src/constants/endpoints";
import tokens from "src/constants/tokens";
import { Proposal, ProposalState, ProposalType, Vote } from "src/slices/types";
...
export const calculateVoteResults = (votes: Vote[]): { [key: string]: Vote[] } => {
  if (votes) {
    return votes.reduce((accum, vote) => {
      ...
      return {
        ...accum,
        [choiceText]: accum[choiceText as keyof typeof accum]
          ? [...accum[choiceText as keyof typeof accum], vote]
          : [vote],
      };
    }, {});
  }
