import { Button, CheckmarkIcon, CogIcon, LinkExternal, Text, /*Toggle,*/ useTooltip } from "@pancakeswap/uikit";
...
import { acceptListUpdate, /*disableList, enableList,*/ removeList } from "../../slices/lists/actions";
import { useActiveListUrls, useAllLists, useIsListActive } from "../../slices/lists/hooks";
...
const ListRow = memo(function ListRow({ listUrl }: { listUrl: string }) {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <div>
      <Text color="white">{list && listVersionLabel(list.version)}</Text>
      <LinkExternal external href={`https://tokenlists.org/token-list?url=${listUrl}`} color="#09FDB5">
        {t("See")}
      </LinkExternal>
    ...
    <RowWrapper active={isActive} key={listUrl} id={listUrlRowHTMLId(listUrl)}>
      ...
      <Column style={{ flex: "1" }}>
        <Row>
          ...
          <span style={{ marginLeft: "1rem", marginRight: "1rem" }} ref={targetRef}>
