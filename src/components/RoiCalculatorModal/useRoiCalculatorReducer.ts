...
import { getInterestBreakdown, getPrincipalForInterest, getRoi } from "src/utils/compoundApyHelpers";
...
const roiCalculatorReducer = (
  ...
  switch (action.type) {
    ...
    case "setCompoundingFrequency": {
      ...
      const compoundingFrequency = compoundingIndexToFrequency[index as keyof typeof compoundingIndexToFrequency];
