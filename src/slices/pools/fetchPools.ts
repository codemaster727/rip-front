...
import multicall, { multicallv2 } from "src/utils/multicall";
...
export const fetchPoolsBlockLimits = async () => {
  ...
  const startEndBlockResult = startEndBlockRaw.reduce((resultArray: any, item: any, index: any) => {
...
export const fetchPoolsStakingLimits = async (
  ...
  return poolStakingChunkedResultRaw.reduce((accum, stakingLimitRaw: any[], index) => {
...
export const fetchPoolsProfileRequirement = async (): Promise<{
  ...
  return poolStakingChunkedResultRaw.reduce((accum, poolProfileRequireRaw: any[], index) => {
