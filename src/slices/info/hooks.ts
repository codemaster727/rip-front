...
import { AppDispatch, AppState } from "src/Root";
import fetchPoolChartData from "src/slices/info/queries/pools/chartData";
import fetchPoolTransactions from "src/slices/info/queries/pools/transactions";
import fetchTokenChartData from "src/slices/info/queries/tokens/chartData";
import fetchPoolsForToken from "src/slices/info/queries/tokens/poolsForToken";
import fetchTokenPriceData from "src/slices/info/queries/tokens/priceData";
import fetchTokenTransactions from "src/slices/info/queries/tokens/transactions";
import { Transaction } from "src/slices/info/types";
...
export const usePoolDatas = (poolAddresses: string[]): PoolData[] => {
  ...
  return poolsWithData as PoolData[];
};
...
export const useTokenDatas = (addresses?: string[]): TokenData[] | undefined => {
  ...
  return tokensWithData as TokenData[];
};
