...
import { mapBurns, mapMints, mapSwaps } from "src/slices/info/queries/helpers";
import { BurnResponse, MintResponse, SwapResponse } from "src/slices/info/queries/types";
