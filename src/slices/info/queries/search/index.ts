...
import { MINIMUM_SEARCH_CHARACTERS } from "src/constants/info";
import { usePoolDatas, useTokenDatas } from "src/slices/info/hooks";
import { PoolData, TokenData } from "src/slices/info/types";
...
const useFetchSearchResults = (
  ...
  const tokensLoading = (tokenDatasFull as any).length !== searchResults.tokens.length || searchResults.loading;
