...
export interface SwapState {
  ...
  readonly pairDataById: Record<string, Record<string, PairDataNormalized>> | null;
  readonly derivedPairDataById: Record<string, Record<string, DerivedPairDataNormalized>> | null;
}
