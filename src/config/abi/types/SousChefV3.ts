...
export interface SousChefV3Interface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, string, BigNumberish, BigNumberish, BigNumberish, BigNumberish, BigNumberish, string],
  ): string;
  encodeFunctionData(functionFragment: "isInitialized", values?: undefined): string;
  encodeFunctionData(functionFragment: "lastRewardBlock", values?: undefined): string;
  encodeFunctionData(functionFragment: "numberBlocksForUserLimit", values?: undefined): string;
  encodeFunctionData(functionFragment: "owner", values?: undefined): string;
  encodeFunctionData(functionFragment: "pancakeProfile", values?: undefined): string;
  encodeFunctionData(functionFragment: "pancakeProfileIsRequested", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "numberBlocksForUserLimit", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "owner", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "pancakeProfile", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "pancakeProfileIsRequested", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "updateProfileAndThresholdPointsRequirement", data: BytesLike): Result;
  ...
  getEvent(nameOrSignatureOrTopic: "UpdateProfileAndThresholdPointsRequirement"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Withdraw"): EventFragment;
}

export type DepositEvent = TypedEvent<[string, BigNumber], { user: string; amount: BigNumber }>;

export type DepositEventFilter = TypedEventFilter<DepositEvent>;

export type EmergencyWithdrawEvent = TypedEvent<[string, BigNumber], { user: string; amount: BigNumber }>;

export type EmergencyWithdrawEventFilter = TypedEventFilter<EmergencyWithdrawEvent>;

export type NewPoolLimitEvent = TypedEvent<[BigNumber], { poolLimitPerUser: BigNumber }>;

export type NewPoolLimitEventFilter = TypedEventFilter<NewPoolLimitEvent>;

export type NewRewardPerBlockEvent = TypedEvent<[BigNumber], { rewardPerBlock: BigNumber }>;
...
export type RewardsStopEvent = TypedEvent<[BigNumber], { blockNumber: BigNumber }>;
...
export interface SousChefV3 extends BaseContract {
  ...
  populateTransaction: {
    ...
    numberBlocksForUserLimit(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    owner(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    pancakeProfile(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    pancakeProfileIsRequested(overrides?: CallOverrides): Promise<PopulatedTransaction>;
