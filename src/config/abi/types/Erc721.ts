...
export type MintEvent = TypedEvent<[string, BigNumber], { _to: string; _tokenId: BigNumber }>;
...
export interface Erc721 extends BaseContract {
  ...
  filters: {
    "Mint(address,uint256)"(_to?: string | null, _tokenId?: BigNumberish | null): MintEventFilter;
    ...
    Transfer(_from?: string | null, _to?: string | null, _tokenId?: null): TransferEventFilter;
    ...
    Approval(_owner?: string | null, _approved?: string | null, _tokenId?: null): ApprovalEventFilter;
  };
