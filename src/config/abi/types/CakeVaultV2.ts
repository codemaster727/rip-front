...
export interface CakeVaultV2Interface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "freeFeeUsers", values: [string]): string;
  ...
  encodeFunctionData(functionFragment: "setFreeFeeUser", values: [string, boolean]): string;
  ...
  decodeFunctionResult(functionFragment: "freeFeeUsers", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "setFreeFeeUser", data: BytesLike): Result;
...
export type HarvestEvent = TypedEvent<[string, BigNumber], { sender: string; amount: BigNumber }>;
...
export interface CakeVaultV2 extends BaseContract {
  ...
  callStatic: {
    ...
    setFreeFeeUser(_user: string, _free: boolean, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    freeFeeUsers(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
