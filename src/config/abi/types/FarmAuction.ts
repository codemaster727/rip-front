...
export type AuctionStructOutput = [number, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
  status: number;
...
export interface FarmAuctionInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "auctionBids", values: [BigNumberish, string]): string;
  ...
  encodeFunctionData(functionFragment: "claimAuction", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "claimAuctionLeaderboard", values: [BigNumberish, string[]]): string;
  encodeFunctionData(functionFragment: "claimable", values: [BigNumberish, string]): string;
  encodeFunctionData(functionFragment: "closeAuction", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "currentAuctionId", values?: undefined): string;
  encodeFunctionData(functionFragment: "maxAuctionLength", values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: "setMaxAuctionLength", values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "viewAuctions", values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "viewBidderAuctions", values: [string, BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "viewBidders", values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "claimAuction", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "claimAuctionLeaderboard", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "maxAuctionLength", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "setMaxAuctionLength", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "viewAuctions", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewBidderAuctions", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewBidders", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewBidsPerAuction", data: BytesLike): Result;
...
export type NewMaxAuctionLengthEvent = TypedEvent<[BigNumber], { maxAuctionLength: BigNumber }>;

export type NewMaxAuctionLengthEventFilter = TypedEventFilter<NewMaxAuctionLengthEvent>;
...
export interface FarmAuction extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[BigNumber, boolean] & { totalAmount: BigNumber; hasClaimed: boolean }>;
    ...
    claimable(auctionId: BigNumberish, bidder: string, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    viewBidders(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<[string[], BigNumber]>;
  ...
  bid(_amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    claimAuction(_auctionId: BigNumberish, overrides?: CallOverrides): Promise<void>;

    claimAuctionLeaderboard(_auctionId: BigNumberish, _bidders: string[], overrides?: CallOverrides): Promise<void>;

    claimable(auctionId: BigNumberish, bidder: string, overrides?: CallOverrides): Promise<boolean>;

    closeAuction(_bidLimit: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    removeWhitelist(_bidders: string[], overrides?: CallOverrides): Promise<void>;

    renounceOwnership(overrides?: CallOverrides): Promise<void>;

    setMaxAuctionLength(_maxAuctionLength: BigNumberish, overrides?: CallOverrides): Promise<void>;

    setOperatorAddress(_operatorAddress: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    AuctionBid(auctionId?: BigNumberish | null, account?: string | null, amount?: null): AuctionBidEventFilter;
    ...
    "NewMaxAuctionLength(uint256)"(maxAuctionLength?: null): NewMaxAuctionLengthEventFilter;
    NewMaxAuctionLength(maxAuctionLength?: null): NewMaxAuctionLengthEventFilter;

    "NewOperatorAddress(address)"(account?: string | null): NewOperatorAddressEventFilter;
    ...
    "WhitelistRemove(address)"(account?: string | null): WhitelistRemoveEventFilter;
    WhitelistRemove(account?: string | null): WhitelistRemoveEventFilter;
  };

  estimateGas: {
    addWhitelist(_bidders: string[], overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;

    auctionBids(arg0: BigNumberish, arg1: string, overrides?: CallOverrides): Promise<BigNumber>;

    auctions(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    bid(_amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    claimable(auctionId: BigNumberish, bidder: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    viewAuctions(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    viewBidders(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    auctionBids(arg0: BigNumberish, arg1: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    claimable(auctionId: BigNumberish, bidder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    viewAuctions(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    viewBidders(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    whitelisted(bidder: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
