...
export interface SyrupInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "safeCakeTransfer", values: [string, BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: "safeCakeTransfer", data: BytesLike): Result;
...
export interface Syrup extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SyrupInterface;
  ...
  callStatic: {
    ...
    "mint(uint256)"(amount: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
    ...
    safeCakeTransfer(_to: string, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
