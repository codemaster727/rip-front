...
export interface Multicall extends BaseContract {
  ...
  estimateGas: {
    aggregate(calls: CallStruct[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    tryAggregate(requireSuccess: boolean, calls: CallStruct[], overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    aggregate(calls: CallStruct[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
