...
export interface MasterchefInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getBoostValue", values: [string, BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "maxBoostValue", values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: "updateBoostContract", values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: "updateBurnAdmin", values: [string]): string;
  encodeFunctionData(functionFragment: "updateCakeRate", values: [BigNumberish, BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "updatePool", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "updateUserBoost", values: [string, BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "whiteListMapping", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "getBoostValue", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "maxBoostValue", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "whiteListMapping", data: BytesLike): Result;
...
export type SetPoolEvent = TypedEvent<[BigNumber, BigNumber], { pid: BigNumber; allocPoint: BigNumber }>;
...
export type UpdateBurnAdminEvent = TypedEvent<[string, string], { oldAdmin: string; newAdmin: string }>;
...
export type UpdateWhiteListEvent = TypedEvent<[string, boolean], { user: string; isValid: boolean }>;
...
export interface Masterchef extends BaseContract {
  ...
  functions: {
    ...
    burnCake(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
    ...
    getBoostValue(_user: string, _pid: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  callStatic: {
    ...
    updatePool(_pid: BigNumberish, overrides?: CallOverrides): Promise<PoolInfoStructOutput>;

    updateUserBoost(_user: string, _pid: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    UpdateBoostContract(boostContract?: string | null, maxBoostVal?: null): UpdateBoostContractEventFilter;
    ...
    UpdateUserBoost(user?: string | null, oldBoostVal?: null, newBoostVal?: null): UpdateUserBoostEventFilter;
  ...
  estimateGas: {
    ...
    burnCake(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    whiteListMapping(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    burnCake(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    getBoostValue(_user: string, _pid: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    whiteListMapping(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
