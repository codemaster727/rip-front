...
export interface BunnyFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "bunnyFactoryV2", values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: "setBunnyJson", values: [string, string, string, string, string]): string;
  encodeFunctionData(functionFragment: "setStartBlockNumber", values: [BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: "bunnyFactoryV2", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "setBunnyJson", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "setStartBlockNumber", data: BytesLike): Result;
...
export interface BunnyFactory extends BaseContract {
  ...
  callStatic: {
    ...
    setStartBlockNumber(_newStartBlockNumber: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    updateTokenPrice(_newTokenPrice: BigNumberish, overrides?: CallOverrides): Promise<void>;
  };
  ...
  populateTransaction: {
    ...
    canMint(userAddress: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
