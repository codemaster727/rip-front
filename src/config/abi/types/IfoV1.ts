...
export interface IfoV1Interface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getOfferingAmount", values: [string]): string;
  encodeFunctionData(functionFragment: "getRefundingAmount", values: [string]): string;
  ...
  encodeFunctionData(functionFragment: "offeringAmount", values?: undefined): string;
  encodeFunctionData(functionFragment: "offeringToken", values?: undefined): string;
  encodeFunctionData(functionFragment: "raisingAmount", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "getOfferingAmount", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "offeringAmount", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "offeringToken", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "raisingAmount", data: BytesLike): Result;
...
export interface IfoV1 extends BaseContract {
  ...
  functions: {
    ...
    getOfferingAmount(_user: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    getRefundingAmount(_user: string, overrides?: CallOverrides): Promise<[BigNumber]>;

    getUserAllocation(_user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    Harvest(user?: string | null, offeringAmount?: null, excessAmount?: null): HarvestEventFilter;
  };
  ...
  populateTransaction: {
    ...
    getOfferingAmount(_user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getRefundingAmount(_user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getUserAllocation(_user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    harvest(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;

    hasHarvest(_user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
