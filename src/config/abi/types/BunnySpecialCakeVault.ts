...
export interface BunnySpecialCakeVaultInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "changeCampaignId", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "changeEndBlock", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "changeNumberPoints", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "changeThresholdTimestamp", values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: "thresholdTimestamp", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "changeThresholdTimestamp", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "thresholdTimestamp", data: BytesLike): Result;
...
export type NewCampaignIdEvent = TypedEvent<[BigNumber], { campaignId: BigNumber }>;
...
export type NewNumberPointsEvent = TypedEvent<[BigNumber], { numberPoints: BigNumber }>;

export type NewNumberPointsEventFilter = TypedEventFilter<NewNumberPointsEvent>;

export type NewThresholdTimestampEvent = TypedEvent<[BigNumber], { thresholdTimestamp: BigNumber }>;

export type NewThresholdTimestampEventFilter = TypedEventFilter<NewThresholdTimestampEvent>;
...
export interface BunnySpecialCakeVault extends BaseContract {
  ...
  functions: {
    ...
    mintNFT(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    changeCampaignId(_campaignId: BigNumberish, overrides?: CallOverrides): Promise<void>;

    changeEndBlock(_endBlock: BigNumberish, overrides?: CallOverrides): Promise<void>;

    changeNumberPoints(_numberPoints: BigNumberish, overrides?: CallOverrides): Promise<void>;

    changeThresholdTimestamp(_thresholdTimestamp: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "NewThresholdTimestamp(uint256)"(thresholdTimestamp?: null): NewThresholdTimestampEventFilter;
    NewThresholdTimestamp(thresholdTimestamp?: null): NewThresholdTimestampEventFilter;
  ...
  estimateGas: {
    ...
    canClaim(_userAddress: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    mintNFT(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    canClaim(_userAddress: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    mintNFT(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    thresholdTimestamp(overrides?: CallOverrides): Promise<PopulatedTransaction>;
