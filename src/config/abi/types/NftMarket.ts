...
export type CollectionStructOutput = [number, string, string, BigNumber, BigNumber] & {
  status: number;
  creatorAddress: string;
  whitelistChecker: string;
...
export interface NftMarketInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "TOTAL_MAX_FEE", values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: "buyTokenUsingBNB", values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: "buyTokenUsingWBNB", values: [string, BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "calculatePriceAndFeesForCollection", values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: "canTokensBeListed", values: [string, BigNumberish[]]): string;
  encodeFunctionData(functionFragment: "cancelAskOrder", values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: "claimPendingRevenue", values?: undefined): string;
  encodeFunctionData(functionFragment: "closeCollectionForTradingAndListing", values: [string]): string;
  encodeFunctionData(functionFragment: "createAskOrder", values: [string, BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "maximumAskPrice", values?: undefined): string;
  encodeFunctionData(functionFragment: "minimumAskPrice", values?: undefined): string;
  encodeFunctionData(functionFragment: "modifyAskOrder", values: [string, BigNumberish, BigNumberish]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "pendingRevenue", values: [string]): string;
  encodeFunctionData(functionFragment: "recoverFungibleTokens", values: [string]): string;
  encodeFunctionData(functionFragment: "recoverNonFungibleToken", values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
  encodeFunctionData(functionFragment: "setAdminAndTreasuryAddresses", values: [string, string]): string;
  encodeFunctionData(functionFragment: "transferOwnership", values: [string]): string;
  encodeFunctionData(functionFragment: "treasuryAddress", values?: undefined): string;
  encodeFunctionData(functionFragment: "updateMinimumAndMaximumPrices", values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "viewAsksByCollection", values: [string, BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "viewAsksByCollectionAndTokenIds", values: [string, BigNumberish[]]): string;
  encodeFunctionData(
    functionFragment: "viewAsksByCollectionAndSeller",
    values: [string, string, BigNumberish, BigNumberish],
  ): string;
  encodeFunctionData(functionFragment: "viewCollections", values: [BigNumberish, BigNumberish]): string;

  decodeFunctionResult(functionFragment: "TOTAL_MAX_FEE", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "buyTokenUsingBNB", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "buyTokenUsingWBNB", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "calculatePriceAndFeesForCollection", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "canTokensBeListed", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "cancelAskOrder", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "claimPendingRevenue", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "closeCollectionForTradingAndListing", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "createAskOrder", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "maximumAskPrice", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "minimumAskPrice", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "modifyAskOrder", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "modifyCollection", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "onERC721Received", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "owner", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "pendingRevenue", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "recoverFungibleTokens", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "recoverNonFungibleToken", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "renounceOwnership", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "setAdminAndTreasuryAddresses", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "transferOwnership", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "treasuryAddress", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "updateMinimumAndMaximumPrices", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewAsksByCollection", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewAsksByCollectionAndTokenIds", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewAsksByCollectionAndSeller", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewCollections", data: BytesLike): Result;
  ...
  getEvent(nameOrSignatureOrTopic: "NewAdminAndTreasuryAddresses"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "NewMinimumAndMaximumAskPrices"): EventFragment;
...
export type CollectionUpdateEventFilter = TypedEventFilter<CollectionUpdateEvent>;

export type NewAdminAndTreasuryAddressesEvent = TypedEvent<[string, string], { admin: string; treasury: string }>;

export type NewAdminAndTreasuryAddressesEventFilter = TypedEventFilter<NewAdminAndTreasuryAddressesEvent>;
...
export type NewMinimumAndMaximumAskPricesEventFilter = TypedEventFilter<NewMinimumAndMaximumAskPricesEvent>;

export type NonFungibleTokenRecoveryEvent = TypedEvent<[string, BigNumber], { token: string; tokenId: BigNumber }>;

export type NonFungibleTokenRecoveryEventFilter = TypedEventFilter<NonFungibleTokenRecoveryEvent>;

export type OwnershipTransferredEvent = TypedEvent<[string, string], { previousOwner: string; newOwner: string }>;

export type OwnershipTransferredEventFilter = TypedEventFilter<OwnershipTransferredEvent>;

export type RevenueClaimEvent = TypedEvent<[string, BigNumber], { claimer: string; amount: BigNumber }>;
...
export interface NftMarket extends BaseContract {
  ...
  functions: {
    ...
    claimPendingRevenue(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  canTokensBeListed(_collection: string, _tokenIds: BigNumberish[], overrides?: CallOverrides): Promise<boolean[]>;
  ...
  callStatic: {
    ...
    buyTokenUsingBNB(_collection: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    cancelAskOrder(_collection: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;

    claimPendingRevenue(overrides?: CallOverrides): Promise<void>;

    closeCollectionForTradingAndListing(_collection: string, overrides?: CallOverrides): Promise<void>;
    ...
    recoverFungibleTokens(_token: string, overrides?: CallOverrides): Promise<void>;

    recoverNonFungibleToken(_token: string, _tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    AskCancel(collection?: string | null, seller?: string | null, tokenId?: BigNumberish | null): AskCancelEventFilter;
    ...
    "CollectionClose(address)"(collection?: string | null): CollectionCloseEventFilter;
    ...
    NonFungibleTokenRecovery(token?: string | null, tokenId?: BigNumberish | null): NonFungibleTokenRecoveryEventFilter;
    ...
    "RevenueClaim(address,uint256)"(claimer?: string | null, amount?: null): RevenueClaimEventFilter;
    RevenueClaim(claimer?: string | null, amount?: null): RevenueClaimEventFilter;
  ...
  estimateGas: {
    ...
    canTokensBeListed(_collection: string, _tokenIds: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    claimPendingRevenue(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    viewCollections(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    claimPendingRevenue(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
    ...
    pendingRevenue(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    viewCollections(cursor: BigNumberish, size: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
