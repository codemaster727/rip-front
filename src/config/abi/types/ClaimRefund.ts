...
export interface ClaimRefundInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getCakeBack", values?: undefined): string;
  encodeFunctionData(functionFragment: "hasClaimed", values: [string]): string;
  encodeFunctionData(functionFragment: "numberCake", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "getCakeBack", data: BytesLike): Result;
...
export interface ClaimRefund extends BaseContract {
  ...
  functions: {
    ...
    getCakeBack(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    getCakeBack(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getCakeBack(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
