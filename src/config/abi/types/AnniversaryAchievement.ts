...
export interface AnniversaryAchievementInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "changeNumberPointsAndThreshold", values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "claimAnniversaryPoints", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "changeNumberPointsAndThreshold", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "claimAnniversaryPoints", data: BytesLike): Result;
  ...
  getEvent(nameOrSignatureOrTopic: "NewNumberPointsAndThreshold"): EventFragment;
...
export type NewNumberPointsAndThresholdEventFilter = TypedEventFilter<NewNumberPointsAndThresholdEvent>;
...
export interface AnniversaryAchievement extends BaseContract {
  ...
  functions: {
    ...
    claimAnniversaryPoints(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    NewNumberPointsAndThreshold(numberPoints?: null, thresholdPoints?: null): NewNumberPointsAndThresholdEventFilter;
  ...
  estimateGas: {
    ...
    claimAnniversaryPoints(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    canClaim(_user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    claimAnniversaryPoints(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>;
