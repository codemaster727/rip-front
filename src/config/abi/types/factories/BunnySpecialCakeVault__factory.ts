...
import type { BunnySpecialCakeVault, BunnySpecialCakeVaultInterface } from "../BunnySpecialCakeVault";
...
export class BunnySpecialCakeVault__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): BunnySpecialCakeVault {
    return new Contract(address, _abi, signerOrProvider) as BunnySpecialCakeVault;
  }
}
