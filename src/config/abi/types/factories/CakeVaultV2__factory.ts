...
import type { CakeVaultV2, CakeVaultV2Interface } from "../CakeVaultV2";
...
export class CakeVaultV2__factory {
  static readonly abi = _abi;
  static createInterface(): CakeVaultV2Interface {
    return new utils.Interface(_abi) as CakeVaultV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): CakeVaultV2 {
    return new Contract(address, _abi, signerOrProvider) as CakeVaultV2;
  }
}
