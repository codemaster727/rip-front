...
import type { TradingCompetitionV2, TradingCompetitionV2Interface } from "../TradingCompetitionV2";
...
export class TradingCompetitionV2__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): TradingCompetitionV2 {
    return new Contract(address, _abi, signerOrProvider) as TradingCompetitionV2;
  }
}
