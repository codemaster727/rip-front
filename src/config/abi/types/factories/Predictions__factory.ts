...
export class Predictions__factory {
  ...
  static createInterface(): PredictionsInterface {
    return new utils.Interface(_abi) as PredictionsInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Predictions {
    return new Contract(address, _abi, signerOrProvider) as Predictions;
  }
}
