...
import type { PancakeProfile, PancakeProfileInterface } from "../PancakeProfile";
...
export class PancakeProfile__factory {
  static readonly abi = _abi;
  static createInterface(): PancakeProfileInterface {
    return new utils.Interface(_abi) as PancakeProfileInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): PancakeProfile {
