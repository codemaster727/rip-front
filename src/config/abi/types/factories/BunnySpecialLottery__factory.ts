...
import type { BunnySpecialLottery, BunnySpecialLotteryInterface } from "../BunnySpecialLottery";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IPancakeSwapLottery",
        name: "",
        type: "address",
      },
    ],
...
export class BunnySpecialLottery__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): BunnySpecialLottery {
