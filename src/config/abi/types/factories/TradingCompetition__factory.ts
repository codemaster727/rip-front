...
import type { TradingCompetition, TradingCompetitionInterface } from "../TradingCompetition";
...
export class TradingCompetition__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): TradingCompetition {
