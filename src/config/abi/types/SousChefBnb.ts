...
export interface SousChefBnbInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "limitAmount", values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: "setBlackList", values: [string]): string;
  encodeFunctionData(functionFragment: "setLimitAmount", values: [BigNumberish]): string;
  ...
  decodeFunctionResult(functionFragment: "limitAmount", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "setLimitAmount", data: BytesLike): Result;
...
export interface SousChefBnb extends BaseContract {
  ...
  callStatic: {
    ...
    removeBlackList(_blacklistAddress: string, overrides?: CallOverrides): Promise<void>;
    ...
    setBlackList(_blacklistAddress: string, overrides?: CallOverrides): Promise<void>;

    setLimitAmount(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
