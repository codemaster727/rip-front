...
export interface LotteryV2Interface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "MAX_LENGTH_LOTTERY", values?: undefined): string;
  encodeFunctionData(functionFragment: "MAX_TREASURY_FEE", values?: undefined): string;
  encodeFunctionData(functionFragment: "MIN_DISCOUNT_DIVISOR", values?: undefined): string;
  encodeFunctionData(functionFragment: "MIN_LENGTH_LOTTERY", values?: undefined): string;
  encodeFunctionData(functionFragment: "buyTickets", values: [BigNumberish, BigNumberish[]]): string;
  ...
  encodeFunctionData(functionFragment: "changeRandomGenerator", values: [string]): string;
  encodeFunctionData(functionFragment: "claimTickets", values: [BigNumberish, BigNumberish[], BigNumberish[]]): string;
  encodeFunctionData(functionFragment: "closeLottery", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "currentLotteryId", values?: undefined): string;
  encodeFunctionData(functionFragment: "currentTicketId", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "drawFinalNumberAndMakeLotteryClaimable",
    values: [BigNumberish, boolean],
  ): string;
  encodeFunctionData(functionFragment: "injectFunds", values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(functionFragment: "injectorAddress", values?: undefined): string;
  encodeFunctionData(functionFragment: "maxNumberTicketsPerBuyOrClaim", values?: undefined): string;
  encodeFunctionData(functionFragment: "maxPriceTicketInCake", values?: undefined): string;
  encodeFunctionData(functionFragment: "minPriceTicketInCake", values?: undefined): string;
  encodeFunctionData(functionFragment: "operatorAddress", values?: undefined): string;
  encodeFunctionData(functionFragment: "owner", values?: undefined): string;
  encodeFunctionData(functionFragment: "pendingInjectionNextLottery", values?: undefined): string;
  encodeFunctionData(functionFragment: "randomGenerator", values?: undefined): string;
  encodeFunctionData(functionFragment: "recoverWrongTokens", values: [string, BigNumberish]): string;
  encodeFunctionData(functionFragment: "renounceOwnership", values?: undefined): string;
  encodeFunctionData(functionFragment: "setMaxNumberTicketsPerBuy", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "setMinAndMaxTicketPriceInCake", values: [BigNumberish, BigNumberish]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "viewCurrentLotteryId", values?: undefined): string;
  encodeFunctionData(functionFragment: "viewLottery", values: [BigNumberish]): string;
  encodeFunctionData(functionFragment: "viewNumbersAndStatusesForTicketIds", values: [BigNumberish[]]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "MAX_LENGTH_LOTTERY", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "MAX_TREASURY_FEE", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "MIN_DISCOUNT_DIVISOR", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "MIN_LENGTH_LOTTERY", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "calculateTotalPriceForBulkTickets", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "changeRandomGenerator", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "claimTickets", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "closeLottery", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "currentLotteryId", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "currentTicketId", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "drawFinalNumberAndMakeLotteryClaimable", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "injectFunds", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "injectorAddress", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "maxNumberTicketsPerBuyOrClaim", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "maxPriceTicketInCake", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "minPriceTicketInCake", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "operatorAddress", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "owner", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "pendingInjectionNextLottery", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "randomGenerator", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "recoverWrongTokens", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "renounceOwnership", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "setMaxNumberTicketsPerBuy", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "setMinAndMaxTicketPriceInCake", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "setOperatorAndTreasuryAndInjectorAddresses", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "startLottery", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "transferOwnership", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "treasuryAddress", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewCurrentLotteryId", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewLottery", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewNumbersAndStatusesForTicketIds", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewRewardsForTicketId", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "viewUserInfoForLotteryId", data: BytesLike): Result;
  ...
  getEvent(nameOrSignatureOrTopic: "NewOperatorAndTreasuryAndInjectorAddresses"): EventFragment;
...
export type AdminTokenRecoveryEvent = TypedEvent<[string, BigNumber], { token: string; amount: BigNumber }>;
...
export type LotteryInjectionEventFilter = TypedEventFilter<LotteryInjectionEvent>;
...
export type LotteryNumberDrawnEventFilter = TypedEventFilter<LotteryNumberDrawnEvent>;
...
export type NewRandomGeneratorEvent = TypedEvent<[string], { randomGenerator: string }>;

export type NewRandomGeneratorEventFilter = TypedEventFilter<NewRandomGeneratorEvent>;
...
export interface LotteryV2 extends BaseContract {
  ...
  functions: {
    ...
    viewLottery(_lotteryId: BigNumberish, overrides?: CallOverrides): Promise<[LotteryStructOutput]>;
  ...
  callStatic: {
    ...
    buyTickets(_lotteryId: BigNumberish, _ticketNumbers: BigNumberish[], overrides?: CallOverrides): Promise<void>;
    ...
    changeRandomGenerator(_randomGeneratorAddress: string, overrides?: CallOverrides): Promise<void>;
    ...
    closeLottery(_lotteryId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    injectFunds(_lotteryId: BigNumberish, _amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    setMaxNumberTicketsPerBuy(_maxNumberTicketsPerBuy: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    "AdminTokenRecovery(address,uint256)"(token?: null, amount?: null): AdminTokenRecoveryEventFilter;
    AdminTokenRecovery(token?: null, amount?: null): AdminTokenRecoveryEventFilter;

    "LotteryClose(uint256,uint256)"(
      lotteryId?: BigNumberish | null,
      firstTicketIdNextLottery?: null,
    ): LotteryCloseEventFilter;
    LotteryClose(lotteryId?: BigNumberish | null, firstTicketIdNextLottery?: null): LotteryCloseEventFilter;

    "LotteryInjection(uint256,uint256)"(
      lotteryId?: BigNumberish | null,
      injectedAmount?: null,
    ): LotteryInjectionEventFilter;
    LotteryInjection(lotteryId?: BigNumberish | null, injectedAmount?: null): LotteryInjectionEventFilter;
    ...
    "NewRandomGenerator(address)"(randomGenerator?: string | null): NewRandomGeneratorEventFilter;
    NewRandomGenerator(randomGenerator?: string | null): NewRandomGeneratorEventFilter;
  ...
  estimateGas: {
    ...
    viewLottery(_lotteryId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;

    viewNumbersAndStatusesForTicketIds(_ticketIds: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    MAX_LENGTH_LOTTERY(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    MAX_TREASURY_FEE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    MIN_DISCOUNT_DIVISOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    MIN_LENGTH_LOTTERY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    maxNumberTicketsPerBuyOrClaim(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    maxPriceTicketInCake(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    minPriceTicketInCake(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    operatorAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    owner(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    pendingInjectionNextLottery(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    viewCurrentLotteryId(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    viewLottery(_lotteryId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
